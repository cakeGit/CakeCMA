...
import com.cake.ccma.converter_tool.source.exception.SourceReadError;
import com.cake.ccma.core.CcmaFileExtensions;
...
public class SourcesReader {
    ...
    protected static void tryReadSource(String subdirectory, File file) {
        try {
            if (file.getName().endsWith(CcmaFileExtensions.SOURCE_DEFINITION_EXTENSION)) {
