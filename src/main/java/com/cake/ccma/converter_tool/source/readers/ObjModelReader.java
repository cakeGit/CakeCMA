...
import com.cake.ccma.core.model.*;
...
public class ObjModelReader implements SubmodelReader {
    ...
    public Submodel readSource(JSONObject source, File file) throws SourceCompileError {
        ...
        if (source.containsKey("material_map")) {
    ...
    List<String> silencedTokens = List.of(
        "mtllib" //Materials are externally defined (being a link to a resource location) so these sources can be ignored
    );
