...
public class SourcesReader {
    ...
    private static void readSourceFile(String subdirectory, File file) throws SourceReadError {
        ...
        JSONObject fileData = safeJSONAction(()->new JSONObject(fileContents.toString()));
        
        String displayName = fileData.has("display_name") ? fileData.getString("display_name") : null;
        currentReaderDisplayName = displayName;
        
        if (!fileData.has("model_sources"))
